...
CREATE TABLE `users` (
  ...
  `pen_name`      VARCHAR(80) DEFAULT NULL,
...
CREATE TABLE `tags` (
  ...
  CREATE TABLE `books` (
    ...
    `audit_comment` TEXT,
    `shelf_status`  VARCHAR(20) NOT NULL DEFAULT 'down',
    `off_shelf_reason` VARCHAR(255) DEFAULT NULL,
    `audit_submitted_at` DATETIME DEFAULT NULL,
