...
- 阅读入口与在线阅读器：支持书籍阅读入口页、章节阅读、目录面板、阅读偏好、划线、评论、书签和阅读进度同步。
- 社区互动：提供 `/community` 书单/书评广场，支持公开书单、公开书评、书评赞同和兴趣标签展示。
- 用户中心：包含个人资料、头像上传、密码修改、我的收藏、阅读历史、阅读统计和阅读成就。
...
- `/api`：首页推荐、搜索、分类、标签、兴趣标签、榜单、书籍详情、阅读入口、阅读器、评论、书架、推荐反馈、社区书单和社区书评。
